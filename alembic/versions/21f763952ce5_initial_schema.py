...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("is_best_match", sa.Boolean(), nullable=False, server_default=sa.text("true")),
    ...
    op.create_index(
        op.f("ix_trade_data_symbol"), "trade_data", ["symbol"], unique=False
    )
    op.create_index(
        op.f("ix_trade_data_timestamp"), "trade_data", ["timestamp"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        "features",
        sa.Column("market_data_timestamp", sa.DateTime(), nullable=False),
        sa.Column("market_data_symbol", sa.String(length=20), nullable=False),
        sa.Column("market_data_interval", sa.String(length=10), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["market_data_timestamp", "market_data_symbol", "market_data_interval"],
        ...
        sa.UniqueConstraint(
            ...
            "feature_name",
            name="uix_feature_market_data_feature_name",
        ),
    )
    op.create_index(
        "ix_feature_market_data_feature_name",
        "features",
        ["market_data_timestamp", "market_data_symbol", "market_data_interval", "feature_name"],
        unique=False,
    )
    op.create_table(
        "portfolio_assets",
