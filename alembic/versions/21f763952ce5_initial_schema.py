...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('symbol', 'interval', 'timestamp', name='uix_market_data_symbol_interval_timestamp')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('market_data_id', 'feature_name', name='uix_feature_market_data_id_feature_name')
    )
    op.create_index('ix_feature_market_data_id_feature_name', 'features', ['market_data_id', 'feature_name'], unique=False)
    op.create_index(op.f('ix_features_market_data_id'), 'features', ['market_data_id'], unique=False)
    ...
    sa.Column('train_metrics', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index(op.f('ix_strategies_model_id'), 'strategies', ['model_id'], unique=False)
